...
define void @PW1Conv(i32 %isize, i32 %osize, i32 %inputchannel, i32 %outputchannel) #0 {
entry:
...
for.cond4.preheader.lr.ph:                        ; preds = %for.cond1.preheader
  %arrayidx8 = getelementptr inbounds i32, i32* inttoptr (i64 788533628 to i32*), i64 %indvars.iv13
...
for.body6.prol:                                   ; preds = %for.body6.preheader
  ...
  %arrayidx.prol = getelementptr inbounds i32, i32* inttoptr (i64 788533596 to i32*), i64 %idxprom.prol
...
for.body6:                                        ; preds = %for.body6.preheader17, %for.body6
  ...
  %arrayidx = getelementptr inbounds i32, i32* inttoptr (i64 788533596 to i32*), i64 %idxprom
  ...
  %arrayidx.1 = getelementptr inbounds i32, i32* inttoptr (i64 788533596 to i32*), i64 %idxprom.1
...
if.else:                                          ; preds = %if.else.loopexit, %for.cond4.preheader
  ...
  %arrayidx22 = getelementptr inbounds i32, i32* inttoptr (i64 788533660 to i32*), i64 %idxprom21
